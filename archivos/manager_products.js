...
async function run () {
    ...
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 3", 160, "Sin imagen", "code125", 10)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 4", 180, "Sin imagen", "code126", 160)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 5", 170, "Sin imagen", "code127", 120)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 6", 145, "Sin imagen", "code128", 200)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 7", 185, "Sin imagen", "code129", 300)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 8", 125, "Sin imagen", "code129", 400)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 9", 145, "Sin imagen", "code130", 250)
    await manager.addProduct ("Producto Prueba 3", "Es un producto prueba 10", 100, "Sin imagen", "code135", 150)
